...
CREATE TABLE portal (
                        jid        TEXT, -- TODO Remove
                        thread_id  TEXT,
                        receiver   TEXT,
                        mxid       TEXT UNIQUE,
                        name       TEXT    NOT NULL, -- TODO Remove
                        name_set   BOOLEAN NOT NULL DEFAULT false, -- TODO Remove
                        topic      TEXT    NOT NULL, -- TODO Remove
                        topic_set  BOOLEAN NOT NULL DEFAULT false, -- TODO Remove
                        avatar     TEXT    NOT NULL, -- TODO Remove
                        avatar_url TEXT, -- TODO Remove
                        avatar_set BOOLEAN NOT NULL DEFAULT false, -- TODO Remove
                        ...
                        PRIMARY KEY (jid, receiver) -- TODO Just use thread_id
);
CREATE INDEX portal_parent_group_idx ON portal(parent_group);

CREATE TABLE puppet (
                        username     TEXT PRIMARY KEY, -- TODO Should use contact.phoneNumber from API
                        displayname  TEXT,
